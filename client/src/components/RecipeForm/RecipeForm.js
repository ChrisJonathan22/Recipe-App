...
export default class RecipeForm extends Component {
   ...
   getData(files) {
    ...
    async sendData() {
        let { postData } = this.state;
        let { editMode, id } = this.props;

        if (postData || this.props.editMode) {
                    ...
                    <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                                <Box component="form" sx={{ '& > :not(style)': { m: 1, width: '60%' } }} validate autoComplete="off">
                                    <TextField id="outlined-basic" className='form-title' label="Title" placeholder='Enter the title' name='title' variant="outlined" defaultValue={this.props.title ? this.props.title : null} />
                                    ...
                                    <TextField id="outlined-basic" className='form-duration' label="Duration" placeholder='Enter the duration' name='duration' variant="outlined" defaultValue={this.props.duration ? this.props.duration : null} />

                                    <TextField multiline fullWidth id="outlined-textarea" className='form-steps' label="Steps" placeholder='Enter the steps...' name='steps' variant="outlined" defaultValue={this.props.steps ? this.props.steps : null} />
                       
                                    <TextField id="outlined-basic" className='form-rating' label="Rating" placeholder='Enter the difficulty between 0-5' name='rating' variant="outlined" defaultValue={this.props.rating ? this.props.rating : null} />
